...
fn main() raises:
    with DeviceContext() as ctx:
        ...
        out_tensor = LayoutTensor[dtype, out_layout, MutableAnyOrigin](out.unsafe_ptr());
        a_tensor = LayoutTensor[dtype, layout, MutableAnyOrigin](a.unsafe_ptr());
        b_tensor = LayoutTensor[dtype, layout, MutableAnyOrigin](b.unsafe_ptr());
